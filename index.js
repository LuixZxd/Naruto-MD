...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠉⠛⠶⢦⣤⣄⣀⣼⡧⠖⠋⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
    ...
    const subtitle = chalk.hex('#00eaff').bold('✦ ZyprahBOT-MD ✦').padStart(40)
    const poweredMsg = chalk.hex('#00eaff').italic('powered by Brayan')
    const aiMsg = chalk.hex('#ffb300').bold('🤖 ZyprahAi - Tu compañera virtual')
    const tips = [
        chalk.hex('#ffb300')('💡 Tip: Usa /help para ver los comandos disponibles.'),
        chalk.hex('#00eaff')('� Síguenos en GitHub para actualizaciones.'),
        chalk.hex('#ff00cc')('✨ Disfruta de la experiencia premium de ZyprahAi.')
    ]
    const loadingFrames = [
    ...
    console.log(
        chalk.bold.cyanBright(
            boxen(
                chalk.bold('¡Bienvenido a ZyprahAi!\n') +
...
if (connection == 'open') {
console.log(chalk.bold.green('\n✨️ ZyprahMD ya esta conectada ✨️'))
}
